...
use app\admin\service\Rockball2Service;
 ...
 * 滚球2接口
 */
class Rockball2Controller extends Controller
{
    #[Inject]
    protected Rockball2Service $rockBallService;
    ...
    public function exportList(Request $request): Response
    {
        ...
        if (isset($params['promote'])) {
            $params['promote'] = intval($params['promote']);
        }
